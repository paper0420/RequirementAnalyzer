...
var currentKLHs = ExcelTableReader.ReadFile("Specification_V05.xlsx", "KLH", (t, y) => Requirement.CreateOrNull(t, y)).DataRows;
var syrs = ExcelTableReader.ReadFile("SYR_KLH11C2.4SP21-2211-2137.120_BL2.0.xlsx", "Sheet1", (t, y) => SYR.CreateOrNull(t, y)).DataRows;
var executedTestcases = ExcelTableReader
    .ReadFile("Specification_V05.xlsx", "Test_Item", (t, y) => ENG10Testcase.CreateOrNull(t, y))
    .DataRows
    .Where(t => t != null)
    .Cast<ENG10Testcase>()
    .ToList();

var deltaSYRs = ExcelTableReader.ReadFile("DeltaSYR.xlsx", "Sheet1", (t, y) => DeltaSYR.CreateOrNull(t, y)).DataRows;
